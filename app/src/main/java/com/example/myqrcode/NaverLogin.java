...
public class NaverLogin extends AppCompatActivity {
     ...
     * client 정보를 넣어준다.
     */
    private static String OAUTH_CLIENT_ID = "XvIEOd7XXB5YcIpJZOF0";
    private static String OAUTH_CLIENT_SECRET = "xxx";
    private static String OAUTH_CLIENT_NAME = "Myqrcode";
